...
// If using TypeScript, ensure the following line is at the top of your file or in a global.d.ts:
// /// <reference types="react" />

// --- BentoGrid and BentoCard components (from your provided code) ---



function BentoGrid({ children, className = "", ...props }: { children: React.ReactNode, className?: string, [key: string]: any }) {
  return (
    <div
